 ...
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, UserLoginTask.IUserLoginTask {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthTask = (UserLoginTask) getIntent().getSerializableExtra("Auth");
...
//        if (mAuthTask == null || !mAuthTask.IsLoggedIn()){
//            System.exit(0);
//        }
    }
